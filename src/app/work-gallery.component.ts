        ...
        @for (post of posts; track post.title) {
          <article class="post-card">
            ...
            <div class="post-content">
              ...
              <a [href]="post.href" target="_blank" rel="noreferrer">Open <b>↗</b></a>
            </div>
          </article>
        }
      </section>
